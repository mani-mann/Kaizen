...
while True:
    ...
    for row in results:
        ...
        jobexists(jobid,cur) # NOTE sometimes keyword creator deletes the keyword, which causes job not found problem. this checks if job exists before generating docket
