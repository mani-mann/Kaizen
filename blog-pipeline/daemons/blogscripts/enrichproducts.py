...
def getpptdescription(imagebaselist):
    prompt = 'Give a brief description of the slides which offer the most USP and their aspects for purposes solved by this PPT template which are given images of in a single crisp short paragraph. Describe the functional aspects of the PPT template as a whole. Keep it all under 50 words.'
    prompt = 'Give a brief description of the slides which offer the most USP and their aspects for purposes solved by this PPT template which are given images of in a few sentences. Describe the functional aspects of the PPT template as a whole. Keep it all under 30 words.'
...
def main(blog,imagelimit):
    for i in range(len(blog['main']['products'])):
        ...
        blog['main']['products'][i]['raw'] = getpptdescription(getimagebaselist(getimageurls(imageurltemplate,imagelimit)))
